...
export const metadata: Metadata = {
  title: "Terms of Service — DMOOP",
  description:
    "The terms and conditions that govern your use of DMOOP. Effective " + EFFECTIVE_DATE + ".",
  alternates: { canonical: "/terms" },
  openGraph: {
    title: "Terms of Service — DMOOP",
    description: "The terms and conditions that govern your use of DMOOP.",
    url: "/terms",
    type: "website",
  },
};
...
export default function TermsPage() {
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Terms of Service", item: "https://www.dmoop.com/terms" },
    ],
  };
      ...
      <article className="relative max-w-3xl mx-auto px-4 sm:px-6 pt-10 sm:pt-16 pb-12 sm:pb-20 w-full">
        ...
        <div className="resource-prose">
          <p>
            ...
            &quot;Customer&quot;) and DMOOP (&quot;DMOOP&quot;, &quot;we&quot;, &quot;us&quot;) governing your access to and use of
            the DMOOP platform, including
          ...
          <h2>2. The Service</h2>
          <p>
            DMOOP provides an AI-assisted marketing intelligence platform that helps you draft, plan,
          ...
          <p>
            ...
            You grant DMOOP a worldwide, non-exclusive, royalty-free license to host, process, transmit,
          ...
          <p>
            ...
            business or legal purpose. To the extent permitted by law, DMOOP assigns to you whatever
          ...
          <p>
            Except for Customer Content and AI-generated output as described above, DMOOP and its
          ...
          <p>
            ...
            <Link href="/privacy" className="text-[var(--dmoop-accent)] font-medium">
              Privacy Policy
            </Link>
          ...
          <p>
            ...
            PERMITTED BY LAW, DMOOP DISCLAIMS ALL WARRANTIES, WHETHER EXPRESS, IMPLIED, OR STATUTORY,
            INCLUDING WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE, AND
            NON-INFRINGEMENT. DMOOP DOES NOT WARRANT THAT THE SERVICE WILL BE UNINTERRUPTED, ERROR-FREE,
            SECURE, OR THAT AI OUTPUT WILL BE ACCURATE, COMPLETE, OR APPROPRIATE FOR ANY PURPOSE.
          </p>

          <h2>11. Limitation of liability</h2>
          <p>
            TO THE FULLEST EXTENT PERMITTED BY LAW, IN NO EVENT WILL DMOOP, ITS AFFILIATES, OFFICERS,
            ...
            OF OR RELATED TO THESE TERMS OR YOUR USE OF THE SERVICE. DMOOP&apos;S AGGREGATE LIABILITY
            FOR ANY CLAIM ARISING OUT OF OR RELATED TO THESE TERMS OR THE SERVICE WILL NOT EXCEED THE
            GREATER OF (A) THE AMOUNT YOU PAID TO DMOOP IN THE TWELVE MONTHS PRECEDING THE CLAIM, OR
            (B) ONE HUNDRED U.S. DOLLARS (USD 100).
          </p>

          <h2>12. Indemnification</h2>
          <p>
            You agree to defend, indemnify, and hold harmless DMOOP and its affiliates, officers,
          ...
          <p>
            ...
            applicable fees, or use the Service in a way that could subject DMOOP to liability. Upon
          ...
          <p>
            ...
            and you and DMOOP consent to the personal jurisdiction of those courts. If you are based
          ...
          <p>
            ...
            agreement between you and DMOOP regarding the Service. If any provision is found
          ...
          <p>
            ...
            <a href="mailto:legal@dmoop.com" className="text-[var(--dmoop-accent)] font-medium">
              legal@dmoop.com
            </a>
            .
          </p>
      ...
      <footer className="relative py-8 border-t border-[var(--dmoop-border-soft)] mt-auto">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-5">
            ...
            <Link href="/privacy" className="text-[12px] font-medium text-[var(--dmoop-text-secondary)] hover:text-[var(--dmoop-text-primary)]">
              Privacy
            </Link>
